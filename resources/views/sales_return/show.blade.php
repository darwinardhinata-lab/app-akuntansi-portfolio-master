...
@section('top_bar_left')
    ...
    <x-breadcrumb :links="['Penjualan' => '#', 'Retur Penjualan' => route('sales-returns.index'), 'Pemeriksaan Gudang' => null]" />
@endsection
...
<div class="container-fluid px-4 py-3">
    ...
    <form action="{{ route('sales-returns.process', $return->id) }}" method="POST">
        ...
        <div class="card border-0 shadow-sm rounded-3 mb-3">
            <div class="card-body p-4">
                <div class="row g-3">
                    ...
                    <div class="col-md-3">
                        <small class="text-muted fw-bold d-block">Ref. Faktur (Invoice)</small>
        ...
        <div class="alert alert-info border-start border-info border-4" role="alert">
            ...
            <a href="{{ route('sales-returns.index') }}" class="alert-link fw-bold ms-2">Kembali ke daftar</a>.
        </div>
        @endif
    </form>
</div>
