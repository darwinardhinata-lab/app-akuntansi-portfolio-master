...
@section('top_bar_left')
    ...
    <x-breadcrumb :links="['Pembelian' => '#', 'Purchase Orders' => route('po.index'), 'Edit' => null]" />
@endsection
...
<div class="container-fluid mx-auto mt-4 mb-5" style="max-width: 1400px;">
    <form action="{{ route('po.update', $po->id) }}" method="POST" id="form-po">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h4 class="fw-bold mb-0 text-dark">Edit Purchase Order</h4>
            <div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="is_include_ppn" id="is_include_ppn" class="form-select form-select-sm fw-bold">
                                <option value="0" {{ $po->is_include_ppn == 0 ? 'selected' : '' }}>Exclude PPN (Belum Termasuk)</option>
                                <option value="1" {{ $po->is_include_ppn == 1 ? 'selected' : '' }}>Include PPN (Sudah Termasuk)</option>
                            </select>
                        </div>
                        <div class="mb-3">
