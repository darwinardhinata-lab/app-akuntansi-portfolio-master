...
@section('top_bar_left')
    ...
    <x-breadcrumb :links="['Penjualan' => '#', 'Sales Orders' => route('so.index'), 'Buat Baru' => null]" />
@endsection
...
<div class="container-fluid mx-auto mt-4 mb-5" style="max-width: 1400px;">
    <form action="{{ route('so.store') }}" method="POST" id="form-so">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h4 class="fw-bold mb-0 text-dark">Tambah Pesanan Penjualan</h4>
            <div>
                <a href="{{ route('so.index') }}" class="btn btn-outline-secondary fw-bold px-3 me-2">Batal</a>
                <button type="submit" class="btn btn-primary fw-bold px-4 shadow-sm"><i class="fa-solid fa-save me-1"></i> Simpan Pesanan</button>
            </div>
        </div>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <select name="is_cod" class="form-select">
                                    ...
                                    <option value="1">Ya (Cash on Delivery)</option>
                                </select>
                            </div>
                            <div class="col-md-4">
