...
@section('top_bar_left')
    ...
    <x-breadcrumb :links="['Pembelian' => '#', 'Tagihan Pembelian' => route('purchase-bills.index'), 'Detail Tagihan' => null]" />
@endsection
...
<div class="container-fluid px-4 py-3">
    ...
    <div class="card border-0 shadow-sm rounded-3 mb-3">
        <div class="card-body p-4">
            <div class="row g-3">
                <div class="col-md-3">
                    <small class="text-muted fw-bold d-block">No. Tagihan</small>
                    <span class="fw-bold text-warning fs-5">{{ $bill->bill_number }}</span>
                </div>
                <div class="col-md-3">
                    <small class="text-muted fw-bold d-block">Tanggal</small>
                    <span class="fw-bold">{{ date('d M Y', strtotime($bill->transaction_date)) }}</span>
                </div>
                <div class="col-md-3">
                    <small class="text-muted fw-bold d-block">Supplier</small>
                ...
                <div class="col-md-3 mt-3">
                    <small class="text-muted fw-bold d-block">Status Bayar</small>
                    <span class="badge {{ $bill->payment_status === 'PAID' ? 'bg-success' : 'bg-danger' }} px-3 py-2">{{ $bill->payment_status }}</span>
                </div>
                <div class="col-md-3 mt-3">
                    <small class="text-muted fw-bold d-block">Total Tagihan</small>
    ...
    <div class="card border-0 shadow-sm rounded-3 mb-3">
        <div class="card-header bg-white p-3 border-bottom">
            <h5 class="fw-bold mb-0"><i class="fa-solid fa-boxes me-2"></i> Detail Barang</h5>
        </div>
        <div class="table-responsive">
            <table class="table table-bordered align-middle mb-0" style="font-size: 0.85rem;">
                ...
                <tbody>
                    ...
                    @empty
                    <tr>
                        <td colspan="6" class="text-center py-4 text-muted">Tidak ada detail barang.</td>
                    </tr>
                    @endforelse
                </tbody>
